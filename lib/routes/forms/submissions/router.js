...
router.get('/', paginate.middleware(), handlers.list);
...
router.post('/search', paginate.middleware(), handlers.search);
...
router.post('/filter', paginate.middleware(), handlers.filter);
